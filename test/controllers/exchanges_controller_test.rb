...
class ExchangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post exchanges_url, params: { exchange: { description: @exchange.description, name: @exchange.name, url: @exchange.url } }, as: :json
    end
  ...
  test "should update exchange" do
    patch exchange_url(@exchange), params: { exchange: { description: @exchange.description, name: @exchange.name, url: @exchange.url } }, as: :json
    assert_response 200
  end
